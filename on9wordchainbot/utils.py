...
ADD_TO_GROUP_KEYBOARD = inline_keyboard_from_button(
    types.InlineKeyboardButton("Add to group", url="https://t.me/Velocityxrobot?startgroup=_")
)
ADD_ON9BOT_TO_GROUP_KEYBOARD = inline_keyboard_from_button(
    types.InlineKeyboardButton("Add On9Bot to group", url="https://t.me/Gojo_X_Jinwoo_bot?startgroup=_")
)
